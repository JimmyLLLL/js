...
// 高频 https://wenku.baidu.com/view/1943881ab81aa8114431b90d6c85ec3a87c28bfc.html
const ES = {}
const fatigue = '疲劳的'
...
const porch = '门廊'
const episode = '一个事件、连续剧的一集'
const impact = '告知、赋予'
const rear = '后方的'
const condemn = '谴责'
const vocal = '直言不讳的'
const underlying = '含蓄的、潜在的'
const litter = '废弃物'
const layman = '外行'
const sculpture = '雕刻'
const shepherd = '牧羊人'
...
const shuttle = '航天飞机'
const precede = '先于'
const forthcoming = '即将到来的'
const commonplace = '普通的'
const hinder = '妨碍'
const defect = '缺点'
const aisle = '通道'
const collide = '碰撞'
...
const epidemic = '流行病'
const elapse = '逝去'
const plausible = '似有道理的'
const generalize = '概括'
const prevalent = '流行的'
const lean = '倾斜'
const spill = '溢出'
const encounter = '遇到、遭遇'
const dilute = '稀释'
const stitch = '缝'
const doom = '注定'
const discern = '看出'
